...
from calculosolar.models import GeracaoPrevistaPF, CalculoSolarPF, CalculoIrradianciaSolar, CalculoPotenciaGeracaoPF, QntPaineisPF,AdicaoPotenciaKWHMes,CalcPotenciaAdicional
from calculosolar.forms import CalculoSolarPFForm, CalculoIrradianciaSolarForm, CalculoPotenciaGeracaoPFForm, QntPaineisPFForm, GeracaoPrevistaPFForm
...
class CalculoIrradianciaAdmin(admin.ModelAdmin):
    form = CalculoIrradianciaSolarForm
...
class CalculoPotGeracaoPFAdmin(admin.ModelAdmin):
    form = CalculoPotenciaGeracaoPFForm
